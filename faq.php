        ...
        <div class="accordion" id="accordion-4">
            ...
            <div class="card">
                <div class="card-header" id="header-4b">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#card-4b"
            ...
            <div class="card">
                <div class="card-header" id="header-4c">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#card-4c"
            ...
            <div class="card">
                <div class="card-header" id="header-4d">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#card-4d"
                ...
                <div class="card">
                    <div class="card-header" id="header-4e">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#card-4e"
                            aria-expanded="false" aria-controls="card-4e">
                            退会したい
                        </button>
                    </div>
